    ...
    <div class="col-sm-6  col-xs-12" id="links">
        ...
        <div id="register_form">
            ...
            <div class="form-group">
                ...
                <span id="detail_error" style="color: red;display: none;"></span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" min="0" class="form-control" id="category_id" >
            </div>
            <div class="form-group">
                <label for="finished_date">Finished ate:</label>
                <input type="number" min="0" class="form-control" id="finished_date" >
            </div>
            <div class="form-group">
                <label for="movie_created_year">Movie created year:</label>
                <input type="number" min="0" class="form-control" id="movie_created_year" >
            </div>
            <div class="form-group">
...
<script>
    ...
    $("#execute").click(function () {
        ...
        var strDetail=$('#detail').val();
        var strAuthor=$('#author').val();
        var intCategoryId=$('#category_id').val();
        var intFinishedDate=$('#finished_date').val();
        ...
        if (blnConfirm == true) {
            ...
            if( !strTitle) {
                ...
                $('#title_error').html("* Title field can not be empty!");
            }

            if( !strDetail) {
                ajaxStatus=false;
                $('#detail_error').css('display', 'inline');
                $('#detail_error').html("* Detail field can not be empty!");
            }
            ...
            if(ajaxStatus) {
                $.ajax({
                    method: 'POST',
                    url: '{{strSubfolderRoute}}/create_item_user_ajax',
                    data: {
                        ajaxUrlType: 'movies',
                        strTitle: strTitle,
                        strDetail: strDetail,
                        ...
                        intFinishedDate: intFinishedDate,
