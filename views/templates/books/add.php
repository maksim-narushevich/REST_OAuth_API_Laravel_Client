    ...
    <div class="col-sm-6  col-xs-12" id="links">
        ...
        <div id="register_form">
            ...
            <div class="form-group">
                ...
                <input type="number" min="0" class="form-control" id="date" >
            </div>
            <div class="form-group">
                <label for="publish_year">Publish year:</label>
                <input type="number" min="0" class="form-control" id="publish_year" >
            </div>
            <div class="form-group">
...
<script>
    ...
    $("#execute").click(function () {
        ...
        var intDate=$('#date').val();
        var intPublishYear=$('#publish_year').val();
